      ...
      <nav
        ...
        <a href="#!">
          {/* <img
            src="./assets/logo.png"
            alt="Logo"
            className="w-28 cursor-pointer mr-14 dark:hidden bg-transparent "
          /> */}
          <h1 className="w-28 cursor-pointer mr-14 dark:hidden bg-transparent font-bold text-2xl">
          ...
          /> */}
          <h1 className="w-28 cursor-pointer mr-14 hidden dark:block bg-transparent font-bold text-2xl text-white">
            Sri Tamilarasi<span className="text-[#b820e6] font-bold">.</span>
          </h1>
        </a>
