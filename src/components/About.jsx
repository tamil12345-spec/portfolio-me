export default function About() {
  const tools = [
    ...
    { name: "postman", icon: "./assets/firebase.png" },
  ...
  const data = [
    ...
    },
    {
      ...
      description:
        "B.Tech in Information Technology, Hindustan College of Engineering and Technology, Coimbatore",
    },
    {
      name: "Projects",
      ...
      <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
        ...
        <div className="flex-1">
          <p className="mb-10 max-w-2xl font-Ovo">
            Hi, I’m Sri Tamilarasi, a passionate and self-driven
            Full-Stack Developer with a strong interest in building modern,
            responsive, and user-friendly web applications. Although I’m at the
            beginning of my professional journey, I have hands-on experience
            working on personal projects that involve both frontend and backend
            technologies.
          </p>
